        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ route('admin.events.list') }}" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Evente</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Evente</h6>
                        <a href="{{ route('admin.event.create') }}">Krijo Event</a>
                    </div>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">EventSphere</a>, All Right Reserved. 
                        </div>
                    </div>
                </div>
            </div>
